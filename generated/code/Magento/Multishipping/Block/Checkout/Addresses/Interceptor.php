...
class Interceptor extends \Magento\Multishipping\Block\Checkout\Addresses implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressOptions');
        if (!$pluginInfo) {
            return parent::getAddressOptions();
        } else {
            return $this->___callPlugins('getAddressOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemUrl');
        if (!$pluginInfo) {
            return parent::getItemUrl($item);
        } else {
            return $this->___callPlugins('getItemUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemDeleteUrl');
        if (!$pluginInfo) {
            return parent::getItemDeleteUrl($item);
        } else {
            return $this->___callPlugins('getItemDeleteUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNewAddressUrl');
        if (!$pluginInfo) {
            return parent::getNewAddressUrl();
        } else {
            return $this->___callPlugins('getNewAddressUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isContinueDisabled');
        if (!$pluginInfo) {
            return parent::isContinueDisabled();
        } else {
            return $this->___callPlugins('isContinueDisabled', func_get_args(), $pluginInfo);
        }
    }
