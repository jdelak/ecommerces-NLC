<?php
namespace Trive\Revo\Block\Slider\Items;

/**
 * Interceptor class for @see \Trive\Revo\Block\Slider\Items
 */
class Interceptor extends \Trive\Revo\Block\Slider\Items implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productsCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Reports\Model\ResourceModel\Product\CollectionFactory $reportsCollectionFactory, \Trive\Revo\Model\ProductSliderFactory $productSliderFactory, \Magento\Framework\Stdlib\DateTime\DateTime $dateTime, \Magento\Reports\Model\Event\TypeFactory $eventTypeFactory, \Magento\Framework\Url\Helper\Data $urlHelper, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $productsCollectionFactory, $catalogProductVisibility, $reportsCollectionFactory, $productSliderFactory, $dateTime, $eventTypeFactory, $urlHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderProducts');
        if (!$pluginInfo) {
            return parent::getSliderProducts($type);
        } else {
            return $this->___callPlugins('getSliderProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderProductsCollection');
        if (!$pluginInfo) {
            return parent::getSliderProductsCollection();
        } else {
            return $this->___callPlugins('getSliderProductsCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSlider');
        if (!$pluginInfo) {
            return parent::setSlider($slider);
        } else {
            return $this->___callPlugins('setSlider', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSlider');
        if (!$pluginInfo) {
            return parent::getSlider();
        } else {
            return $this->___callPlugins('getSlider', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSliderId');
        if (!$pluginInfo) {
            return parent::setSliderId($sliderId);
        } else {
            return $this->___callPlugins('setSliderId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderDisplayId');
        if (!$pluginInfo) {
            return parent::getSliderDisplayId();
        } else {
            return $this->___callPlugins('getSliderDisplayId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRevoProductDetailsHtml');
        if (!$pluginInfo) {
            return parent::getRevoProductDetailsHtml($product);
        } else {
            return $this->___callPlugins('getRevoProductDetailsHtml', func_get_args(), $pluginInfo);
        }
    }
