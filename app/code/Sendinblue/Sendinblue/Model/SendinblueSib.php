    ...
    */
    public function smtpSendMail($userEmail, $title, $tempName, $paramVal)
    {
        ...
        if ($relayData == 'enabled' && !empty($userEmail)) {
            ...
            $objectBlock = $this->getObjRunTime();
            $block = $objectBlock->get('Magento\Backend\Block\Template');
            $path = $block->getViewFileUrl('Sendinblue_Sendinblue::email_temp/'.strtolower($lang).'/'.$tempName.'.html');
