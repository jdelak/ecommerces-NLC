        ...
        try {
            ...
            if ($status == 1) {
                ...
                if (isset($rowList) && $rowList['code'] == 'success' && $rowList['message'] == 'Data retrieved') {
                    ...
                    //old API key.
                    $oldApiKey = trim($model->_getValueDefault->getValue('sendinblue/api_key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE));
                    ...
                    $sendinListdata = $model->_getValueDefault->getValue('sendinblue/selected_list_data', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
                    $sendinFirstrequest = $model->_getValueDefault->getValue('sendinblue/first_request', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    */
    public function sendSmsCampaign()
    {
        ...
        if (!empty($post)) {
            ...
            } else if ($sendinSmsChoice == 0) {
                return $result = $model->multipleChoiceCampaign($post);
            } else if ($sendinSmsChoice == 2) {
